...
public class DataSeeder {
    ...
    private static final List<SeedUser> DEV_USERS = List.of(
    ...
    private static final List<SeedCourse> DEV_COURSES = List.of(
            ...
            new SeedCourse("INT2215", "Lap trinh huong doi tuong", 3, "Tu duy OOP, thiet ke class va clean code co ban"),
    ...
    private static final List<SeedEnrollment> DEV_ENROLLMENTS = List.of(
    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            ...
            int createdClasses = seedClasses(userRepository, courseRepository, courseClassRepository, courseClassService);
    ...
    private int seedEnrollments(
        ...
        for (var seedEnrollment : DEV_ENROLLMENTS) {
            var student = userRepository.findByEmail(seedEnrollment.studentEmail())
                    .orElseThrow(() -> new IllegalStateException("Missing seed student: " + seedEnrollment.studentEmail()));
